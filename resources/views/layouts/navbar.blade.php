...
<body class="text-right">
    <nav class="nav-gradient backdrop-blur-md sticky top-0 z-50 shadow-sm border-b border-blue-200">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center sm:hidden">
                    <button id="mobile-menu-button" type="button"
                        class="inline-flex items-center justify-center rounded-md p-2 text-pink-600 hover:bg-pink-100 focus:outline-none focus:ring-2 focus:ring-pink-200">
                        <span class="sr-only">Open main menu</span>
                        <svg id="menu-icon" class="block h-6 w-6" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <line x1="3" y1="6" x2="21" y2="6" />
                            <line x1="3" y1="12" x2="21" y2="12" />
                            <line x1="3" y1="18" x2="21" y2="18" />
                        </svg>
                        <svg id="close-icon" class="hidden h-6 w-6" fill="none" stroke="currentColor"
                    ...
                    <div class="flex items-center mr-auto"> <!-- mr-auto pushes it to the left -->
                        <div class="flex-shrink-0 flex items-center">
                            <svg class="h-8 w-8 text-pink-600" fill="currentColor" viewBox="0 0 24 24">
                                <img width="50px" src="{{ asset('assets/preg.png') }}" alt="logo">
                            </svg>
        ...
        <div id="mobile-menu" class="hidden sm:hidden px-4 pt-4 pb-3 space-y-2 bg-pink-50">
            <a href="{{ route('home') }}"
                class="block rounded-lg bg-pink-200 px-4 py-2 text-base font-semibold text-pink-900 shadow-sm hover:bg-pink-300 transition flex items-center">
            ...
            <a href="{{ route('pregnancystage') }}"
                class="block rounded-lg px-4 py-2 text-base font-medium text-pink-800 hover:bg-pink-100 transition flex items-center">
                <svg class="w-5 h-5 ml-2 rtl-flip" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
