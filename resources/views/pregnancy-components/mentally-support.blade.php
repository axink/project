        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center">
            ...
            <div class="w-full md:w-1/2 text-center md:text-right">
                <h2 class="text-3xl md:text-4xl font-bold text-pink-700 mb-6 animate-fade-in">
                    چۆن پاڵپشتی دایکان بکەین لە کاتی دووگیانیدا؟
                </h2>
                <p class="text-gray-700 text-lg leading-relaxed mb-6 animate-slide-in">
                    پاڵپشتیکردنی دایکان لە کاتی دووگیانیدا بریتییە لە چارەسەرکردنی پێداویستییە جەستەیی، سۆزداری و
                    کۆمەڵایەتییەکانیان. خۆراکێکی هاوسەنگ دابین بکەن و هانی پشکنینی پێش لەدایکبوون بدەن بۆ دڵنیابوون لە
                    تەندروستی دایک و منداڵ. پاڵپشتی سۆزداری پێشکەش بکە بە گوێگرتن، کەمکردنەوەی دڵەڕاوکێ، و ئاهەنگگێڕانی
                    خاڵە گرنگەکانی وەک سەروو دەنگ یان خۆشوشتنی منداڵ. یارمەتی لە ئەرکەکانی ڕۆژانە و گونجاندن لەگەڵ
                    گۆڕانکاری لە ئاستی وزە. خۆت دەربارەی دووگیانی پەروەردە بکە بۆ تێگەیشتن لە ئاستەنگەکان و پێشکەشکردنی
                    یارمەتی هۆشیارانە. ژینگەیەکی ئاسوودە و سەلامەت دروست بکە و هانی چالاکی جەستەیی سووک بدە، وەک ڕۆیشتن،
                    بەپێی پێشنیاری دابینکارانی تەندروستی. سوپاسگوزاری، ئارامگرتن و هاندان نیشان بدە بۆ ئەوەی گەشتەکە
                    خۆشتر و ئاسانتر بەڕێوە ببە.</p>
                <a href="#more"
    ...
    <section class="py-16" id="more">
        <div class="container mx-auto px-6">
            ...
            <h2 class="text-4xl font-bold text-pink-700 text-center mb-10" data-aos="fade-up">
                کێشە باوەکانی تەندروستی دەروونی لە کاتی دووگیانیدا و چارەسەرەکانیان
            </h2>
