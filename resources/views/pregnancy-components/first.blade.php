...
<body>
    ...
    <div class="w-full">
        ...
        <div class="b1 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 4rem">
            ...
            <div class="b1-text" style="width: 700px">
                ...
                <p class="lg:text-lg italic text-gray-600">
                    ...
                    کرن. ئەو کەسێن ڤان دەمادا گوومانێ د بەن کو ب دووگیانن پێدڤییە ئەو رابن ب ئەنجام دانا تێستا دووگیانیێ
                    داکو پشتراستبن.
                </p>
            </div>
        </div>
        ...
        <div class="b2 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 12rem">
            <div class="b1-text" style="width: 700px">
                <h1 style="font-size: 25px; font-weight: bolder; margin: .1rem;">نەخوشیێت سپێدەهییان و دل ڕابوون
                </h1>
                <p class="lg:text-lg italic text-gray-600">
                    نەخوشیێت سپێدەهییان ئێکە ژ نیشانێت سەرەتای کو ٢-٨ ‌حەفتییان پشتی زکپریێ روویددان و ژ نیشانێت گەلەک
                    بەربەلاڤە د ناڤ ژنێت دووگیان دا. نەخووشیێت سپێدەهییان وەکی دل رابوون بێ زەوقی و سەرئێش و گێژبوون،
                    پتر ئەڤ نیشانێت هە ل سپێدەهییان دیار دبن. ئەڤ نیشانێت هە د بیت ل حەفتییا ١٢ یا دووگییانیێ نەمینن و ل
                    حەفتییا ٣٢ ژ بەری ژ دایک بوونێ دووبارە دەدکەڤنڤە. ئەڤ نیشانێت هە د بیتە ئەگەرێ تێکچوون و دل رابوونێ
                    کوو دبنە ئەگەرێ هشکبوونێ، و ماندیبوونەکا زێدە و ژ هشچوونێ. ئەڤ کەسێت ڤان نیشانا د بینن پێدڤییە هەر
                    زیکا سەرەدانا نوژداری بکەن داکو نوژدار ب کارێ پێدڤی رابت. د گەل هندێ ژیدا بتنێ هندەک ژنێت کێم ژ ژنێت
        ...
        <div class="b1 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 8rem">
            ...
            <div class="b1-text" style="width: 700px">
                <h1 style="font-size: 25px; font-weight: bolder; margin: .1rem;">نازکییا سینگی یان گۆهۆرینا سینگی
                    مەمک</h1>
                <p class="lg:text-lg italic text-gray-600">
                    ...
                    دەمارێت خوینێ زێدەتر د هێن دیتن. ب شێوەک ئاسای سینگ نازک دبت. ئەڤ نیشانێت هە هێدی هێدی کێم دبن پشتی
        ...
        <div class="b2 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 12rem">
            <div class="b1-text" style="width: 700px">
                <h1 style="font-size: 25px; font-weight: bolder; margin: .1rem;"> گەلەک میزتن
                </h1>
                <p class="lg:text-lg italic text-gray-600">
                    گەلەک میزتن ئێکە ژ نیشانێن دەستپێکی کو روویددەن پشتی نەمانا زڤروکا هەیڤانه دیاردبیتن. د دەمێ
                    دووگیانیێ جەسته خوین و شلەمەنییا زێدەتر بەرهەم د ئینت داکو کورپەلە گەشە بکەت. گولچیسک زێدەتر کاردکن
                    بو پاڵاوتنا بڕا زێدەتر یا خوینێ بو دەردانا پاشماوەیان بو ناڤ میزێ. میز رەنگێ وێ توختر دیاردبیت. وەک
                    پرتەقالییەکی یان قەهواییەکی. د گەل مەزنبوونا کورپەلەی مالبچویک مەزنتر لێ دهێت و زێدەتر فشارێ د ئێختە
        ...
        <div class="b1 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 8rem">
            ...
            <div class="b1-text" style="width: 700px">
                <h1 style="font-size: 25px; font-weight: bolder; margin: .1rem;">مانديبوون</h1>
                <p class="lg:text-lg italic text-gray-600">
                    مانديبوون ز نيشانێت دەستپێکینه ددەمێ زکپڕیێ دا، ددەمێ دووگیانیێ دا جەسته ڕێژەکا بلند یا پروجسترونی
                    بەرهەم د ئینت بو بەردەوامییا گەشا کورپەلەی. ژ لایەکێ دیڤەبلند بوونا هورموونان چێدبیت پروسا
                    میتابولیزم هێدی بکەت، د ئەنجامدا جەسته زێدەتر هئزێ و تاقەتێ خەرج دکەت د پروسا هەرسکرنێدا. و ئەڤە د
        ...
        <div class="b2 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 12rem">
            <div class="b1-text" style="width: 700px">
                <h1 style="font-size: 25px; font-weight: bolder; margin: .1rem;"> خوینبەربوونا زێ
                </h1>
                <p class="lg:text-lg italic text-gray-600">
                    خوینبەربوونا زێ نیشانەکا زووی یا دووگییانیێ یە کو ل ٣ هەیڤێت دەستپێکی دا دیار دبیت. پشتی پیتاندنێ،
                    کورپەلە د دیوارێ مالبچوویکی دا دهێتە چاندن و ددەمێ دووگیانیێ دا خال یان خوینبەربوونا زێ روویددەت بێ
        ...
        <div class="b1 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 8rem">
            ...
            <div class="b1-text" style="width: 700px">
                <h1 style="font-size: 25px; font-weight: bolder; margin: .1rem;">سەرئێشی و سەرگێژبوون</h1>
                <p class="lg:text-lg italic text-gray-600">
                    سەرئێشی و سەرگێژبوون ئەڤە ژی ژ نیشانێت دەستپێکینە یێن دووگیانیێ کو ب ئەگەرێ گوهورینا هورمەنێت لەشی و
                    هەروەسا زێدەبوونا سورا خوینێ درووست د بیت. سەرئێشی و سەرگێژبوون د دەمێ دووگیانیێ دا ل دیف هەر
                    حالەتەکێ جەستەی زێدەتر یان کێمتر نەیەکسان دەردکەڤن. ژ هوکارێت وێ ئەوژی گوهورینا هورمونان، سترێس، کێم
                    خەوی یان دەستبەردان ژ کافاینی. ئەو ژنێت کو ئەڤ سەرئێشیە بەردەوام هەی پێدڤی سەرەدانا نەژداری بکەن بو
        ...
        <div class="b2 w-full p-6 flex justify-center gap-40 flex-wrap text-right relative" style="margin-top: 12rem">
            <div class="b1-text" style="width: 700px">
                ...
                <p class="lg:text-lg italic text-gray-600">
                    ...
                    کاریگەریێ لسەر کوئەندامێ هەرسێ دکەت. ئەڤ گوهورینکاریێت هەنێ د بنە ئەگەرێ زێدەبوونا گازێ د گەدەی دا و
