...
<body class="bg-gray-50">
    <a href="{{ route('pregnancystage') }}" class="back-button">
        <button class="bg-blue-500 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all hover:bg-blue-400 flex items-center">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="w-full overflow-hidden flex justify-between flex-wrap relative z-10">
            <div class="text-right p-6 max-w-4xl flex-1">
                <h1 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 animate-fade-in">
                    نیشانێت دەستپێکێ
                </h1>
