        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center">
            ...
            <div class="w-full md:w-1/2 text-center md:text-right">
                <h2 class="text-3xl md:text-4xl font-bold text-pink-700 mb-6 animate-fade-in">
                    بۆچی ل دەمێ دووگیانیدا جیاواز خارنێ دخۆن؟
                </h2>
                <p class="text-gray-700 text-lg leading-relaxed mb-6 animate-slide-in">
                    د دووگیانیدا، ژنان دڤێت بالدارن لسەر خواردنا جۆراجۆر خواردنێن پڕ ڤیتامین ژ هەموو کۆمەلەیێن خواردنان
                    بۆ پشتگیریا تەندروستیا خوە و پەرەسەندنا زارۆکی. ئەڤە تێدا هەیە زۆر میوە و سەوزە، دانەڤۆکێن تەواو،
                    پرۆتینێن سووک، و شیر و بەرهەمێن شیری کەم چەوری یان بێ چەوری. هەروەسا گرنگە ئاڤ ڤەخواردن و بیرکردنا
                    لسەر وەرگرتنا ڤیتامینێن پێش زایینێ وەکو کو پزیشک پێشنیار دکەت.
                </p>
                <a href="#more"
