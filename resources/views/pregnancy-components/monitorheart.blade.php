...
<div class="fixed top-6 left-6 z-50">
    <a href="{{ route('pregnancystage') }}">
        <button class="flex items-center bg-blue-500 text-white px-5 py-2 m-16 rounded-full shadow-md hover:bg-blue-600 transition transform hover:-translate-x-1">
...
<!DOCTYPE html>
<html lang="kn" dir="rtl">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Heart Monitor - Pregnancy</title>
...
<body class="bg-gray-50">
    ...
    <section class="text-center py-12 bg-gradient-to-r from-rose-100 via-pink-50 to-rose-50">
        <div class="max-w-4xl mx-auto px-4">
            <h1 class="text-4xl font-bold text-pink-700 mb-3">💓چاندنا دلێ زارۆکی</h1>
            <p class="text-gray-700 text-sm md:text-base">
                پێزانینێت گرنگ لسەر لێدانێت دلێ زارۆکی، کەنگی دەست ب لێدانێ دکەت چاوا د هێتە پشکنین کرن </p>
            <div class="mt-4 flex justify-center">
                <div class="animate-pulse text-pink-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
    ...
    <section class="max-w-4xl mx-auto px-4 py-10 space-y-8">
        ...
        <div class="bg-white shadow-lg rounded-xl p-6">
            <h2 class="text-xl font-semibold text-rose-700 mb-4 flex items-center">
                ...
                ⏱️گەشە کرنا دلێ زارۆکی د ماوەیێ دووگیانیێ دا
            </h2>
            ...
            <div class="relative mt-6">
                ...
                <div class="space-y-8">
                    <!-- Week 5-6 -->
                    <div class="relative pl-10">
                        <div class="absolute w-8 h-8 bg-pink-500 rounded-full flex items-center justify-center -left-4"
                            style="top: 2px;">
                            <span class="text-white text-xs font-bold">5-6</span>
                        </div>
                        <div class="bg-pink-50 rounded-lg p-4">
                    ...
                    <!-- Week 6 -->
                    <div class="relative pl-10">
                        <div class="absolute w-8 h-8 bg-pink-600 rounded-full flex items-center justify-center -left-4"
                            style="top: 2px;">
                            <span class="text-white text-xs font-bold">6</span>
                        </div>
                        <div class="bg-pink-50 rounded-lg p-4">
                            <h4 class="font-medium text-pink-800">حەفتییا ٦</h4>
                            <p class="text-gray-600 text-sm mt-1">ئێکەم لێدانێت دلی دەستپێدکەن (١٠٠-١٢٠ BPM)</p>
                        </div>
                    </div>

                    <!-- Week 9 -->
                    <div class="relative pl-10">
                        <div class="absolute w-8 h-8 bg-rose-600 rounded-full flex items-center justify-center -left-4"
                            style="top: 2px;">
                            <span class="text-white text-xs font-bold">9</span>
                        </div>
                        <div class="bg-pink-50 rounded-lg p-4">
                            <h4 class="font-medium text-pink-800">حەفتییا ٩</h4>
                            <p class="text-gray-600 text-sm mt-1">لێدانێت دلی بلند دبن (١٤٠-١٧٠ BPM)</p>
                        </div>
                    </div>

                    <!-- Week 12 -->
                    <div class="relative pl-10">
                        <div class="absolute w-8 h-8 bg-rose-700 rounded-full flex items-center justify-center -left-4"
                            style="top: 2px;">
                            <span class="text-white text-xs font-bold">12</span>
                        </div>
                        <div class="bg-pink-50 rounded-lg p-4">
                            <h4 class="font-medium text-pink-800">حەفتییا ١٢</h4>
                            <p class="text-gray-600 text-sm mt-1">لێدانێت دلی دگەهنە ئاستەکێ جێگر (١١٠-١٦٠ BPM)</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-6">
            <h2 class="text-xl font-semibold text-rose-700 mb-4 flex items-center">
                ...
                🧑‍⚕️ چاوا دلێ زارۆکی د هێتە پشکنین کرن؟
            </h2>

            <div class="grid md:grid-cols-3 gap-4 mt-4">
                <!-- Ultrasound -->
                <div
                    class="bg-white border border-pink-100 rounded-lg p-4 text-center hover:shadow-md transition-shadow">
                    <div class="bg-pink-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <h3 class="font-medium text-pink-800">ئەلتراساوند</h3>
                    <p class="text-gray-600 text-xs mt-1">دیتنا دلی د حەفتییا ٦ یا دووگییانیێ دا</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-medium text-pink-800">دۆپلەر</h3>
                    <p class="text-gray-600 text-xs mt-1">گوهلێبوونا دەنگێ دلی د حەفتییا ١٢ یا دووگیانیێ دا</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-medium text-pink-800">فیتۆسکۆپ</h3>
                    <p class="text-gray-600 text-xs mt-1">گوهلێبوونا دەنگێ دلی د حەفتییا ٢٠ یا دووگیانیێ دا</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-6">
            ...
            <div class="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div class="flex-1">
                    <div class="space-y-4">
                        <div>
                            <h4 class="font-medium text-pink-800">لێدانێت دلی یێت ئاسایی </h4>
                            <div class="mt-1 bg-green-50 border border-green-100 rounded p-3">
                                <p class="text-green-800 text-sm">١١٠–١٦٠ لێدان د خولەکەکێ دا (BPM)</p>
                            </div>
                        </div>

                        <div>
                            <h4 class="font-medium text-pink-800">لێدانێ بلەز یێت دلی</h4>
                            <div class="mt-1 bg-yellow-50 border border-yellow-100 rounded p-3">
                                <p class="text-yellow-800 text-sm">زێدەتر ژ ١٦٠ BPM (تاکاردیای جنین)</p>
                            </div>
                        </div>

                        <div>
                            <h4 class="font-medium text-pink-800">لێدانێت دلی یێت هێدی</h4>
                            <div class="mt-1 bg-red-50 border border-red-100 rounded p-3">
                                <p class="text-red-800 text-sm">کێمتر ژ ١١٠ BPM (برادیکاردیای جنین)</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-6">
            <h2 class="text-xl font-semibold text-rose-700 mb-4 flex items-center">
                ...
                ⚠️ کەنگی پێدڤییە یا دل گران بی سەبارەت لێدانێت دلی؟
            </h2>
            ...
            <div class="mt-4 space-y-3">
                <div class="flex items-start">
                    ...
                    <p class="ml-2 text-gray-600 text-sm">ئەگەر لێدانێت دلی کێمتر بن ژ ١١٠ BPM یان زێدەتر ژ ١٦٠ BPM بۆ
                        ماوەیەکێ درێژ</p>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <p class="ml-2 text-gray-600 text-sm">ئەگەر لێدانێت دلی نەرێک بن ئانکو یان گەلەک بلەز بن یان ژی
                        گەلەک هێدی بن</p>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <p class="ml-2 text-gray-600 text-sm">ئەگەر د حەفتییا ٧ێ یا دووگیانیێ دا چ لێدانێت دلی نە بن</p>
                </div>
            </div>

            <div class="mt-6 bg-blue-50 border border-blue-100 rounded-lg p-4">
                <p class="text-blue-800 text-sm">
                    <span class="font-medium">ئامۆژگاری:</span> بو هەر حالەتەکێ کو ببیتە ئەگەرێ دوودلیێ ل دەف تە
                    سەبارەت لێدانێت دلێ زاروکی، ئێکسەر پەیوەندیێ ب نوژداری بکە
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-6">
            ...
            <div class="mt-4 grid md:grid-cols-2 gap-4">
                <div class="bg-pink-50 rounded-lg p-4 flex items-start">
                    <div class="bg-pink-100 p-2 rounded-full mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-pink-600" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
                    ...
                    <p class="text-gray-700 text-sm">ددەمێ پشکنینان دا د ڤێت یا ئارام بی
                    </p>
                </div>
                ...
                <div class="bg-pink-50 rounded-lg p-4 flex items-start">
                    ...
                    <p class="text-gray-700 text-sm">لێدانێت دلی د دەمێ لڤینا زارۆکی دا بلەز تر لێددەت</p>
                </div>
                ...
                <div class="bg-pink-50 rounded-lg p-4 flex items-start">
                    ...
                    <p class="text-gray-700 text-sm">لێدانێت دلی ب بورینا حەفتیان جیاوازییا هەی</p>
                </div>
                ...
                <div class="bg-pink-50 rounded-lg p-4 flex items-start">
                    ...
                    <p class="text-gray-700 text-sm">ڤەخارنا ئاڤێ ب پێ پێدڤییاتیێ ڤەخو بو پاراستنا لێدانێت دلێ زارۆکی
                    </p>
                </div>
            </div>
        </div>
